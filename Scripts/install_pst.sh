...
# ... existing content of install_pst.sh ...

# Trigger ThinkPad Hardware Setup
if [ -f "${scrDir}/install_thinkpad.sh" ]; then
  chmod +x "${scrDir}/install_thinkpad.sh"
  "${scrDir}/install_thinkpad.sh"
fi
